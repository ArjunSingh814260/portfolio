...
export default function Projects() {
  ...
  return (
    <section className="bg-[#121212] pt-8 pb-12 md:pb-24 px-4 sm:px-6 lg:px-12 relative z-20 w-full">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 lg:gap-12 pb-10">
          {projects.map((project, idx) => (
            <motion.div 
              ...
              key={idx} 
              className="group relative rounded-[1.5rem] md:rounded-[2rem] overflow-hidden border border-white/5 bg-white/[0.02] backdrop-blur-md p-6 md:p-12 hover:bg-white/[0.05] transition-colors duration-500 aspect-square md:aspect-[4/3] flex flex-col justify-between hover:shadow-[0_20px_40px_rgba(0,0,0,0.6)] cursor-pointer"
            >
              ...
              <div className="z-10 mt-auto">
                <h3 className="text-2xl md:text-4xl font-semibold text-white mb-4 tracking-tight group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-white group-hover:to-white/70 transition-all duration-300">
                  {project.title}
                </h3>
